...
import { Scale, Users, Gavel, Flag, TrendingUp, BookOpen, Shield, ArrowRight, MessageCircle } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <Link to="/chatbot">
        <div className="fixed bottom-6 right-6 z-50 group">
          <div className="bg-gradient-to-r from-primary to-secondary text-white rounded-full p-4 shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 cursor-pointer">
