  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
        <Card className="w-full max-w-2xl card-legal">
          <CardHeader className="text-center space-y-4">
            <div className="flex justify-center">
              <Scale className="h-12 w-12 text-primary" />
            </div>
            <div>
              <CardTitle className="text-2xl font-bold text-gradient">Join Our Community</CardTitle>
              <CardDescription>Create your account to access legal resources and connect with lawyers</CardDescription>
            </div>
          </CardHeader>
